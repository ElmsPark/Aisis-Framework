...
<div id="pageWrap">
	...
	<header id="header">
		...
		<hgroup>
			<h1 id="siteLogo"><a href="#">Demo</a></h1>
			<h2 id="siteDescription">Site Description</h2>
		</hgroup>

		<nav>
			<ul id="nav" class="clearfix">
				<li><a href="http://webdesignerwall.com">Home</a><ul><li>test</li></ul></li>
	...
	<div id="content">
		...
		<article class="post clearfix">
			...
			<header>
				<h1 class="postTitle"><a href="#">Just a Post Title</a></h1>
				<p class="postMeta"><time class="postDate" datetime="2011-05-08" pubdate>May 8, 2011</time> <em>in</em> <a href="#">Category</a></p>
			</header>
