<?php
/**
 * This class is modeled after the input class, how ever deals with emails.
 * 
 ...
 */
class AisisCore_Form_Elements_Email extends AisisCore_Form_Xhtml{
	/**
	 * Builds the email element.
	 */
