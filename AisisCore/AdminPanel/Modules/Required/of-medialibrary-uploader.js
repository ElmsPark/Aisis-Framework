	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
          ...
          if (itemurl.match(image)) {
            btnContent = '<img src="../../../../AdminPanel/Modules/Required/'+itemurl+'" alt="" /><a href="#" class="mlu_remove button">Remove Image</a>';
          } else {
            ...
            html = '<a href="../../../../AdminPanel/Modules/Required/'+itemurl+'" target="_blank" rel="external">View File</a>';
