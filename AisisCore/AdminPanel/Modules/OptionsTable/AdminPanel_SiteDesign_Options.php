...
function aisis_core_site_design(){		
  ...
  register_setting('aisis-core-options', 'aisis_core', 'color_validation');
...
function general_post_options(){
	...
	$aisis_form->create_aisis_form_element('label', array('value' => 'Would you like to NOT display related posts?'));
	...
	$aisis_form->create_aisis_form_element('label', array('value' => 'Would you like to NOT display a list of catergories for each post?'));
	$aisis_form->create_aisis_form_element('input', array(
		'type' => 'checkbox',
...
function image_header(){
	...
	$aisis_form->create_aisis_form_element('label', array('value' => 'Upload a header image of 980 x 120'));
	$aisis_form->create_aisis_form_element('input', array(
		'type' => 'url',
		'name' => 'aisis_core[image_header]',
		'id' => 'aisis_header_img',
		'value' =>get_option_value('image_header')
	));
	$aisis_form->create_aisis_form_element('input', array(
		'type' => 'button',
		'value' => 'Upload',
...
function links_header_color(){
	$aisis_form = new AisisForm();
	$options = get_option('aisis_core');
	
	$aisis_form->create_aisis_form_element('label', array('value' => 'Change the color of ALL the links: '));
	$aisis_form->create_aisis_form_element('input', array(
		'type' => 'input',
		'name' => 'aisis_core[aisis_link_color]',
		'id' => 'aisis_link_color',
		'value' => get_option_value('aisis_link_color')
	));
	
	$aisis_form->create_aisis_form_element('label', array('value' => 'Change the color of ALL the headers: '));
	$aisis_form->create_aisis_form_element('input', array(
		'type' => 'input',
		'name' => 'aisis_core[aisis_header_colors]',
		'id' => 'aisis_header_colors',
		'value' => get_option_value('aisis_header_colors')
	));	
}
...
function aisis_site_design_bbpress(){
	...
	$aisis_form->create_aisis_form_element('label', array('value' => 'Do you want to use the bbpress footer on the bbpress forum?'));
	$aisis_form->create_aisis_form_element('input', array(
		'type'=>'checkbox',
		'id'=>'designlayout',
...
function color_validation($input){
	$options = get_option('aisis_core');
	$options = $input;
	return $options;
}
