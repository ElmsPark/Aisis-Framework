...
class My_Theme_Options {
	...
	public function add_pages() {
		...
		$admin_page = add_submenu_page('aisis_options', __('Aisis Core Options', 'aisis'), __('Aisis Core Options', 'aisis'), 'manage_options', 'mytheme-options', array( &$this, 'display_page' ));
