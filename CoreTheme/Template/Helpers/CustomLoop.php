 ...
 */
class CoreTheme_Template_Helpers_CustomLoop extends AisisCore_Template_Helpers_Loop_Loop{
	...
	public function init(){
		$this->_components = new CoreTheme_Template_Helpers_LoopComponents($this->_options);
	}
