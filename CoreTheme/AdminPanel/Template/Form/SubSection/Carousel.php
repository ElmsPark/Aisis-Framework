 ...
 * @see CoreTheme_AdminPanel_Template_Form_SubSection_Jumbotron
 * 
 * @package CoreTheme_AdminPanel_Template_Form_SubSection
 */
class CoreTheme_AdminPanel_Template_Form_SubSection_Carousel{
	...
	protected function _add_jumbo_tron(){	
		...
		$jumbo = new CoreTheme_AdminPanel_Template_Form_SubSection_Jumbotron();
