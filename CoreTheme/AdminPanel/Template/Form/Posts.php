 ...
 */
class CoreTheme_AdminPanel_Template_Form_Posts{
	...
	protected function _lists_posts(){
		...
		$list = new CoreTheme_AdminPanel_Template_Form_SubSection_Lists();
	...
	protected function _rows_posts(){
		...
		$rows = new CoreTheme_AdminPanel_Template_Form_SubSection_Rows();
	...
	protected function _category_posts_headers(){
		...
		$category = new CoreTheme_AdminPanel_Template_Form_SubSection_Category();
	...
	protected function _author_posts(){
		...
		$author = new CoreTheme_AdminPanel_Template_Form_SubSection_Author();
	...
	protected function _tag_posts_headers(){
		...
		$tag = new CoreTheme_AdminPanel_Template_Form_SubSection_Tag();
